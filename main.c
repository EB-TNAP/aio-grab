...
static enum {UNKNOWN, PALLAS, VULCAN, WETEKPLAY, XILLEON, BRCM_ARM, BRCM7400, BRCM7401, BRCM7405, BRCM7325, BRCM7335, BRCM7358, BRCM7362, BRCM73625, BRCM7241, BRCM7346, BRCM7356, BRCM73565, BRCM7424, BRCM7425, BRCM7435, BRCM7552, BRCM75845, BRCM7584, BRCM7581, BRCM7583, BRCM7439, HISIL_ARM} stb_type = UNKNOWN;
...
void getvideo(unsigned char *video, int *xres, int *yres)
{
	...
	if (stb_type > XILLEON)
	{
		...
		if (stb_type == BRCM73565 || stb_type == BRCM73625 || stb_type == BRCM75845 || stb_type == BRCM7439)
		{
